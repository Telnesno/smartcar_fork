...
from .coordinator import DATAPOINT_CODE_MAP, SmartcarVehicleCoordinator, IMPERIAL_MEASUREMENTS
...
# description. Imported from coordinator for consistency with polling path.
_IMPERIAL_MEASUREMENTS = IMPERIAL_MEASUREMENTS
