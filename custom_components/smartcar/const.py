...
# v3 API hosts (split from v2's single api.smartcar.com)
VEHICLE_API_HOST = "https://vehicle.api.smartcar.com"
MANAGEMENT_API_HOST = "https://management.api.smartcar.com"

# Alias kept for backward compatibility within the codebase
API_HOST = VEHICLE_API_HOST
