...
async def test_full_flow(
    ...
    if continue_steps:
        ...
        aioclient_mock.get(
            f"{MOCK_API_ENDPOINT}/v3/vehicles/{vehicle_id}/vin", json={"vin": vin}
        )
        aioclient_mock.get(
...
async def test_duplicate_vins_disallowed(
    ...
    aioclient_mock.get(
        f"{MOCK_API_ENDPOINT}/v3/vehicles/{vehicle['id']}/vin",
        json={"vin": vehicle["vin"]},
    )
    aioclient_mock.get(
        f"{MOCK_API_ENDPOINT}/v3/vehicles/{vehicle['id']}",
...
async def test_reauth(
    ...
    aioclient_mock.get(
        f"{MOCK_API_ENDPOINT}/v3/vehicles/{new_vehicle_id}/vin", json={"vin": vin}
    )
    aioclient_mock.get(
        f"{MOCK_API_ENDPOINT}/v3/vehicles/{new_vehicle_id}",
        json={
            "id": new_vehicle_id,
            "make": "TESLA",
            "model": "Model S",
